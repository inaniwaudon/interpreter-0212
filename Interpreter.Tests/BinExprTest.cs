...
public class BinExprTest
{
    ...
    {
        var evaluator = new Evaluator(BinExpr.TLt(IntValue.TInt(1), IntValue.TInt(2)));
    ...
    {
        var evaluator = new Evaluator(BinExpr.TGt(IntValue.TInt(2), IntValue.TInt(1)));
        Assert.Equal(true, evaluator.Evaluate());
    }
    ...
    {
        var evaluator = new Evaluator(BinExpr.TLte(IntValue.TInt(1), IntValue.TInt(1)));
        Assert.Equal(true, evaluator.Evaluate());
    }
